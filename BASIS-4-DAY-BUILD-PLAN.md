...
- Build the read-only Hermes operator:
  - natural-language intake
  - failure classification
  - reconciliation watchdog
  - scheduled Telegram/Discord digest
...
- Hermes produces a real reconciliation report and operations digest while holding no write permission.
...
9. Read-only AI operator; no LLM can move funds.
